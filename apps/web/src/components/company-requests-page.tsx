...
export const CompanyRequestsPage = () => {
  ...
  const filteredFreelancers = useMemo(() => {
    ...
    return state.allFreelancers.filter(f => 
      f.displayName.toLowerCase().includes(freelancerSearchQuery.toLowerCase()) ||
      f.skills.some(s => s.toLowerCase().includes(freelancerSearchQuery.toLowerCase()))
    ).slice(0, 5);
      ...
      {state.status === "ready" && (
        <div className="workspace-grid freelancer-requests-layout">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              <div style={{ padding: "16px", background: "#F9FAFB", borderRadius: "12px", border: "1px solid #E5E7EB" }}>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {freelancerSearchQuery.trim() && filteredFreelancers.length === 0 && (
                    <div style={{ position: "absolute", top: "100%", left: 0, right: 0, background: "#fff", padding: "12px", borderRadius: "8px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", zIndex: 10, marginTop: "4px", fontSize: "13px", color: "#6B7280" }}>
                      ...
                      <article className="status-panel" key={app.id} style={{ padding: 16 }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                          <div>
                            ...
                            <p className="muted" style={{ fontSize: 13, margin: "2px 0 8px" }}>Applied for {app.freelancerEmail}</p>
                          </div>
                          <span style={{ 
                        ...
                        {app.coverNote && (
                          <p style={{ fontSize: 13, background: "#F9FAFB", padding: 10, borderRadius: 8, margin: "8px 0" }}>
                            "{app.coverNote}"
                          </p>
                        )}
                        {app.status === "PENDING" && (
          ...
          <section className="inline-panel" style={{ borderLeft: "1px solid #E5E7EB", paddingLeft: 24 }}>
            ...
            <div style={{ maxHeight: "600px", overflowY: "auto", paddingRight: "10px", margin: "0 -10px 0 0" }}>
              <div className="card-stack">
                    ...
                    <article className="status-panel" key={rec.freelancerId} style={{ padding: 20, border: "1px solid #E5E7EB", position: "relative" }}>
                      ...
                      <div style={{ paddingRight: 60 }}>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginBottom: 12 }}>
                          ...
                          {rec.skills.length > 4 && <span style={{ fontSize: 11, color: "#9CA3AF" }}>+{rec.skills.length - 4} more</span>}
                        </div>
